...
PATCHES=(
	"${FILESDIR}"/patches/${PN}-pkgconf.patch
	"${FILESDIR}"/patches/${PN}-6.4.1-libav-0.8.patch
	"${FILESDIR}"/patches/${PN}-6.4.2-ffmpeg-1.patch
	"${FILESDIR}"/patches/${PN}-6.4.2-configure.patch
	"${FILESDIR}"/patches/${PN}-6.4.2-libav-9.patch
	"${FILESDIR}"/patches/${PN}-6.4.2-iostream.patch
	"${FILESDIR}"/patches/${PN}-6.4.2-v.univar.patch
)
